...
Steps:
1. Read all files in memory/ to load campaign context
2. Read the voice transcript the user has pasted into this conversation
3. Generate complete session notes in the established format outlined in the FORMAT section, below, covering:
