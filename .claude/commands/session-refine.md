...
Steps:
1. Read all files in memory/ for campaign context
2. Read the edited session draft that the user has pasted into this conversation
3. Read the new voice transcript the user has pasted into this conversation
4. Update the draft to reflect new decisions, changed beats, added content,
...
5. Be surgical! Preserve what the transcript doesn't touch
6. Write the updated draft to sessions/sXX_draft.md, where XX is the current session. It's ok to overwrite an older version of a file.
7. Tell the user the file is ready and provide full markdown formatted text in chat for the user to easily copy.
