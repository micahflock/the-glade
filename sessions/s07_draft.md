...
- **The Mantible** — 1d8 finesse short sword (kukri / inverted-falchion shape), can turn invisible. \[MORE DETAIL: invisibility activation rules — at-will, action to toggle, etc. Not in these notes.\]  
- **Mantis-spine dagger** — pulled off one of the scythes if a PC wants it. \[MORE DETAIL: mechanical effect or cosmetic flavor.\]

**Barbra pickup:** Barbra promised to return to the meadow's edge at evening to fly the party home. \[MORE DETAIL: did she show up on time / late / spooked / not at all? Not specified in these notes — this is the active medium-priority thread from campaign\_state.\]
...
**Where to:** The combined Red Ant / Leafcutter colony, by way of Gleam's invitation. They are not racing there — there is room to be waylaid on the road. From the notes: *"They are not racing there — there is room to be waylaid on the road, per the previous prep notes."*
...
\[MORE DETAIL: read-aloud for first sight of the petal palace, the approach, the doorway / receiving line, the dignitary check-in. Not in these notes.\]

### 3c. Entry NPCs

\[MORE DETAIL: who greets dignitaries at the door? Anyone the party should recognize? Any flag-bearing fire ant the party should clock? Not in these notes.\]
...
**Setup:** The Leafcutter Queen is **paraded briefly** through the public space — forced; she's reluctant and obsessed with her fungus work — then escorted back to her private quarters by fire ants.

**Why it matters:** This is the party's only public-area sighting of the target. Reaching her after the parade means leaving the public areas and infiltrating the high-security wing.

\[MORE DETAIL: read-aloud / staging for the parade — what does it look like, how long does it last, what does the Leafcutter Queen visibly look like, does she make eye contact / try to signal anything? Not in these notes.\]

\[MORE DETAIL: which fire ants escort her, in what formation, by what route out of the public area. Not in these notes.\]

### 4b. Public-Area Beats

\[MORE DETAIL: what is actually happening on the floor when the party arrives — band playing, MMA bout in progress, a specific NPC the party should bump into, drink service, dignitary mingling. The notes give the *list of spaces* and the *vibe* but no specific scene beats. Pick at least 1–2 to actually run.\]

\[MORE DETAIL: any social skill checks the DM intends to call for during the public phase — bluffing the dignitary cover, recognizing a hostile face, eavesdropping. Not in these notes.\]

### 4c. Transition to Stealth

\[MORE DETAIL: how does the public phase end / what trigger pushes the party into the stealth phase? Watching the Leafcutter Queen exit? A specific time signal? The end of the session? Not in these notes.\]
...
## B. Fungus-Powered Weapon Rewards (from the Leafcutter Queen)

**Design constraints from the notes:**
...
- The \+1 is the floor. On top of that, each weapon has an **awakening effect** that triggers *the first time it draws blood/ichor in a fight* — the fungus needs to feed to wake up — and the effect lasts for **the duration of that combat.** Notes phrasing: *"the dagger gets fed and then it's hungry for a bit."*  
- Effects should be **orthogonal to the party's existing strengths**, not "+more damage."  
- Notes pitched a "command word" effect (back / forward / down — make the target walk forward 10, back 10, or go prone) and then the DM said *"Let me come up with something. I don't think the command word is necessarily the way to do it."*

\[CLAUDE TASK — deferred per skill rules: design 3 fungus-awakening weapon effects (one per PC, orthogonal to each PC's strengths) for the Leafcutter Queen reward. Surface as a follow-up ask before the heist session.\]

## C. Specialist / Flashback Mechanic (Gleam's offer)
...
## D. Sequencing Reminder

- After Canopia → Red Ant / Leafcutter Queen palace heist (Overgrowth still).  
- After the heist → **the Scorch.**  
- The previous prep-note suggestion — *"base the Red Ant Queen in the scorched place to collapse both threads"* — was **not** taken. The Red Ant / Leafcutter palace is in the Overgrowth, and the Scorch is a separate next destination.
...
- Final four specialist names \+ themes (if Gleam-presents-four model is adopted).
