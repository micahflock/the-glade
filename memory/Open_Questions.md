...
- [ ] **Ahganmin properties:** Glowing magic amber rock given by Garett. Properties TBD. Session 4: confirmed it glows *more strongly* in high-magic environments (the Winter Farm interior). Treat as a reliable ambient-magic indicator; other properties still TBD.
...
- [ ] **Fire Ant Worker stat block:** Referenced but not yet built.
- [ ] **Fire Ant Queen stat block:** Referenced but not yet built.
...
- [x] **Mantis rewards mechanics.** — Decision: Resolved. Drix and Nancy each carry a mandible (The Mantible — 1d8 finesse short sword) and Tabby crafted daggers from mantis spines; all share the same effect — the blade can turn invisible once per short rest. Evidence: party/*.yaml; DM ruling 2026-06-14.
