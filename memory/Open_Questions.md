...
- [ ] **Mantis rewards mechanics.** Loot distribution resolved in Session 6.5: Drix and Nancy each took a mandible (The Mantible — invisible 1d8 finesse short sword); Tabby took mantis spines to craft into daggers. Still TBD: The Mantible's invisibility activation rules (at-will? action? command word?) and the mantis-spine daggers' mechanical effect (or cosmetic only).
- [ ] **Beeatrix's reward.** Amount of gold and any non-monetary token — prep flagged this as TBD. Still open after Session 6.5: the party cleared the meadow but has NOT yet collected the reward from Beeatrix. Pick a number before they next meet her in Canopia.
